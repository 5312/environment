...
export default {
    ...
    toTreeData(data, idKey, pidKey, childKey, pid) {
        ...
        data.forEach(d => {
            ...
            if (
                Array.isArray(pid) ? pid.indexOf(d[pidKey]) !== -1 : d[pidKey] == pid
            ) {
    ...
    getLastMonth() {
        ...
        // this.lastYear = year - 1; //上年
        // this.lastMonth = month; // 上月
        if (month == 0) {
            year = year - 1;
            month = 12;
        }
        return year + "-" + this.doHandleZero(month);
    },
    /**
     * 常用颜色
     */
    ...
    tranNumber(num, point) {
        ...
        if (numStr.length < 6) {
            ...
            let points = dot ? dot : this.digit(0, point);
            return numStr + "." + points;
