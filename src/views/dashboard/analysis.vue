<template>
  <div class="ele-body">
    <el-row :gutter="15">
        ...
        <el-card class="analysis-chart-card" shadow="never">
          ...
          <div class="analysis-chart-card-content" style="padding-top: 18px">
            <span class="ele-action"
              >周同比12%<i class="el-icon-caret-top ele-text-danger"></i
            ></span>
            <span class="ele-action"
              >日同比11%<i class="el-icon-caret-bottom ele-text-success"></i
            ></span>
          </div>
          <el-divider />
      ...
      <el-col :md="6" :sm="12">
        <el-card class="analysis-chart-card" shadow="never">
          <div slot="header">
            <span>运营活动效果</span>
            <el-tag type="success" size="mini" class="ele-pull-right"
              >周</el-tag
            >
          </div>
          ...
          <div class="analysis-chart-card-text">
            <span class="ele-action"
              >周同比12%<i class="el-icon-caret-top ele-text-danger"
            /></span>
            <span class="ele-action"
              >日同比11%<i class="el-icon-caret-bottom ele-text-success"
            /></span>
          </div>
        </el-card>
      </el-col>
    ...
    <el-card shadow="never" body-style="padding:0;">
      ...
      <el-row>
        ...
        <el-col :md="6" :sm="8">
          <div class="demo-monitor-title">
            门店{{
              { saleroom: "销售额", visits: "访问量" }[saleSearch.type]
            }}排名
          </div>
          <div
    ...
    <el-card
      ...
      body-style="padding:10px 5px 0 0;"
    >
      <ele-chart :option="tdd" style="height: 323px" />
    </el-card>
  </div>
</template>
    ...
    payNumChartOption() {
      return {
        tooltip: {
          trigger: "axis",
          formatter:
            '<i class="ele-chart-dot" style="background-color:#3aa1ff;"></i>{b0}: {c0}',
        },
        grid: { top: 10, bottom: 0, left: 0, right: 0 },
        xAxis: [
          {
