    ...
    <div v-if="index == 3" key="123132" class="type-zhilu">
      <el-row :gutter="10" v-loading="topall">
        ...
        <el-col :span="12">
          <el-card shadow="never">
            <div class="title">
              气<i class="el-icon-sunset gree"> </i>
              <el-button style="float: right; padding: 3px 0" type="text">
                <!-- 单位: m³ -->
                <span v-if="twobtn == '1'"> 单位: m³</span>
                <span v-else>单位:元</span>
              </el-button>
            </div>
            <el-table :show-header="false" :data="qi" style="width: 100%">
        ...
        <el-col :span="16">
          <el-card shadow="never">
            ...
            <el-table :data="tableData" style="width: 100%" height="250">
              ...
              <el-table-column prop="qi" label="能源量"> </el-table-column>
...
export default {
  ...
  data () {
    return {
      ...
      tableData: [],
      /****************/
      electricityData: [], // [12, 32, 23, 2, 32, 3, 2, 3], // 用气占比数据
  ...
  computed: {
    ...
    monthAllTopCardData () {
      if (this.month == 1) {
        ...
        return this.qi.length != 0 ? this.qi[1].b : "0"
      }
    },
    yesTadaySame () {
      if (this.month == 1) {
        ...
        return this.qi.length != 0 ? [this.qi[1].s, this.qi[1].z] : [0, 0]
      }
    },
    mei () {
      if (this.coutsIndex != "") {
