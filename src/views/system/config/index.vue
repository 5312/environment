<template>
  <div class="ele-body">
      ...
      <el-row :gutter="15">
        <el-col :md="6" style="margin-bottom:15px;">
          ...
          <ele-data-table ref="table" :config="table" :current.sync="current" :choose="[]" @done="done" highlight-current-row
            ...
            <el-table-column prop="name" label="配置" show-overflow-tooltip min-width="200"/>
    ...
    <!-- 编辑弹窗 -->
    <el-dialog :title="editForm.id?'修改配置':'添加配置'" :visible.sync="showEdit" width="400px"
      ...
      <el-form :model="editForm" ref="editForm" :rules="editRules" label-width="82px">
        <el-form-item label="配置名称:" prop="name">
          <el-input v-model="editForm.name" placeholder="请输入配置名称" clearable/>
        </el-form-item>
