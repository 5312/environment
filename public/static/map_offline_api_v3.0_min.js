...
window.TILE_VERSION = {
    ditu: {
        normal: { version: "088", updateDate: "20220325" },
        satellite: { version: "009", updateDate: "20220325" },
        normalTraffic: { version: "081", updateDate: "20220325" },
        satelliteTraffic: { version: "083", updateDate: "20220325" },
        mapJS: { version: "104", updateDate: "20220325" },
        satelliteStreet: { version: "083", updateDate: "20220325" },
        earthVector: { version: "001", updateDate: "20220325" }
    },
    webapp: {
        high_normal: { version: "001", updateDate: "20220325" },
        lower_normal: { version: "002", updateDate: "20220325" }
    },
    api_for_mobile: {
        vector: { version: "002", updateDate: "20220325" },
        vectorIcon: { version: "002", updateDate: "20220325" }
    }
};
window.BMAP_AUTHENTIC_KEY = "wmW4GGRbIEoK7M5d9XAWbK1OXMqEtzWB";
(function() {
    function aa(a) {
        throw a;
    }
    ...
    function Pa(a, b) {
        if ((a = x.fa(a))) {
            ...
            if (-1 < navigator.userAgent.toLowerCase().indexOf("UCBrowser") ||
                (e && f)
            )
                c.M.VF = 99;
            c.cb = a;
    ...
    function Ua(a, b) {
        if (a) {
            ...
            vb
                ?
                xb.push({
                    src: "product=jsapi&sub_product=jsapi&v=" +
                        A.version +
                        "&sub_product_v=" +
                        A.version +
                        "&t=" +
    ...
    function Jb() {
        var a = document.documentElement,
            b = document.body;
        return a && (a.scrollTop || a.scrollLeft) ? [a.scrollTop, a.scrollLeft] :
            b ? [b.scrollTop, b.scrollLeft] : [0, 0];
    }
    ...
    function xc(a) {
        ...
        for (var b = 0, c = oc, e = 0, f = new Ac(), g = 0, e = 0; e < dc; ++e)
            ...
            fc[(e + 1) % dc] > a.lat &&
            0 <
            Dc({ lng: ec[e], lat: fc[e] }, { lng: ec[(e + 1) % dc], lat: fc[(e + 1) % dc] },
                a
            ) &&
            ++g :
            fc[(e + 1) % dc] <= a.lat &&
                    ...
                    i.lng <= m && i.lng >= p && i.lng <= n && i.lat >= k ?
                        ((e = a.lat * lc),
                            ...
                            (e =
                                ...
                                Math.sin(e) * Math.sin(k)), -1 > e ? (e = -1) : 1 < e && (e = 1),
                            (e = Math.acos(e) * sc)) :
    ...
    x.extend(R, {
        ...
        zP: [
            [
                ...
                8.98305509648872e-6, -1.9939833816331,
                200.9824383106796, -187.2403703815547,
                91.6087516669843, -23.38765649603339,
                2.57121317296198, -0.03801003308653,
                1.73379812e7
            ],
            [-7.435856389565537e-9,
                8.983055097726239e-6, -0.78625201886289,
            ...
            [-1.981981304930552e-8,
                ...
                0.85341911805263,
                0.12923347998204, -0.04625736007561,
                4482777.06
            ],
            [
                3.09191371068437e-9,
                ...
                6.995724062e-5,
                23.10934304144901, -2.3663490511e-4, -0.6321817810242, -0.00663494467273,
                0.03430082397953, -0.00466043876332,
                2555164.4
            ],
            [
                2.890871144776878e-9,
                8.983055095805407e-6, -3.068298e-8,
                7.47137025468032, -3.53937994e-6, -0.02145144861037, -1.234426596e-5,
                1.0322952773e-4, -3.23890364e-6,
                826088.5
            ]
        ],
        wG: [
            ...
            [
                ...
                111320.7020463578,
                6.477955746671607e8, -4.082003173641316e9,
                1.077490566351142e10, -1.517187553151559e10,
                1.205306533862167e10, -5.124939663577472e9,
                9.133119359512032e8,
                67.5
            ],
            [
                0.00337398766765,
                111320.7020202162,
                4481351.045890365, -2.339375119931662e7,
                7.968221547186455e7, -1.159649932797253e8,
                9.723671115602145e7, -4.366194633752821e7,
                8477230.501135234,
                52.5
            ],
            [
        ...
        sd() &&
            (a === l && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")),
                ...
                Wa.load("pointcollection", function() {
                    ...
                    for (a = 0;
                        (b = c.ue[a]); a++) c[b.method].apply(c, b.arguments);
                }));
    }
    ...
    x.extend(Dd.prototype, {
        ...
        is: function(a, b) {
            for (
                var c = 0, e = 6 * Math.pow(2, b - 3), f = e / 2 - 1, g = -e / 2; a > f;
        ...
        cu: function(a) {
            ...
            if (!this.map.Wd() && (a ? (this.map.M.h0 = a) : (a = this.map.M.h0), a))
                for (
                    var c = s,
                        c =
                        "2" == A.Bu ? [A.url.proto + A.url.domain.main_domain_cdn.other[0] + "/"] : [
    ...
    var $d = {
        ...
        MZ: function(a, b, c, e, f, g, i, k, m, n, o, p, v) {
            ...
            if ((n = c.xj(a[0], "pointText", k)) && n.length) {
                ...
                if (y) {
                    for (
                        var z = y.split("").length, B = a[4], D = B.slice(0, 2), G = 2; G < B.length; G += 2
                    )
                    ...
                    for (v = 0; v < b; v++)
                        if (c.Uc(a[7][v], k)) {
                            ...
                            a[6][v] && N.reverse();
                            for (
                                var B = 2 * v * z, B = D.slice(B, B + 2 * z), T = 0; T < z; T++
                            ) {
                                var ea = a[5][z * v + T],
                                    ba = B[2 * T] / 100 / m + g,
                    ...
                    if (k)
                        for (var m = 0; m < k.length; m++)
                            for (var n = k[m], o = 0; o < n.length; o++)
                                if (
                                    ((a = n[o]), !a.wt && a.mt && b > a.Zf && b < a.wi && c > a.$f && c < a.xi)
                                ) {
                                    b = a.mt;
                                    b = {
                                        type: 9,
    ...
    function Geolocation(a) {
        ...
        Wa.load("othersearch", function() {
            for (var a = 0, e;
                (e = b.ue[a]); a++) b[e.method].apply(b, e.arguments);
        });
    }
    ...
    x.extend(Sa.prototype, {
        ...
        UB: function(a) {
            ...
            for (
                var c = a.getPanoMethodList(), e = "", f = 0, g = c.length; f < g; f++
            )
        ...
        ew: function(a) {
            ...
            if (this.enabled) {
                ...
                if (
                    this.options.ey &&
                    (this.options.gl ?
                        ((c = getComputedStyle(this.Rb, s)[Wf].replace(/[^0-9\-.,]/g, "")
                                .split(",")),
                            (e = +(c[12] || c[4])),
                            (c = +(c[13] || c[5]))) :
    ...
    x.extend(sg.prototype, {
        ...
        yy: function(a, b) {
            if (
                ...
                !b && -1 !== e && this.lk[e] && 3 !== this.lk[e].recoType ?
                    ...
                    this.WX(function(a) {
                        for (
                            var b = {}, e, k, m = t, n = [], o = 0, p = a.length; o < p; o++
                        )
                            (e = a[o].catlog),
                            (k = a[o].floor),
                            l !== e &&
        ...
        YV: function() {
            if (!this.Si) {
                ...
                for (
                    var c = this, e = b.getElementsByTagName("span"), f = 0, g = e.length; f < g; f++
                )
                    (b = e[f]),
            ...
            if (this.Si)(a = this.oL(this.Vi)), (this.xQ.innerHTML = a);
                ...
                x.V(b, "click", function(a) {
                    if ((a = (a.srcElement || a.target).getAttribute("dataindex"))) {
                        c.cj(c.aH[a]);
                        for (
                            var e = b.getElementsByTagName("li"), f = 0, g = e.length; f < g; f++
                        )
        ...
        EX: function(a) {
            for (
                var b, c, e, f, g = [], i = this.kg.height, k = this.kg.width, m = 0; m < a.length; m++
            )
                (b = a[m]),
                (recoType = b.recoType),
                (e = b.panoId),
    ...
    wg.prototype = {
        ...
        refresh: function() {
            ...
            this.mg &&
                (this.mg.children[0].style.marginTop = this.Jr.children[0].style.marginTop =
